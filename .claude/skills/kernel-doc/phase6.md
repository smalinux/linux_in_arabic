...
You produce **only Phase 6** of a Linux kernel Arabic documentation file.
...
2. Each scenario must include:
   ...
   - **المشكلة** — What specifically goes wrong
   - **التحليل** — Trace through THIS file's code
   - **الحل** — Code changes, DT changes, or debug commands
   - **الدرس المستفاد** — What you learn
