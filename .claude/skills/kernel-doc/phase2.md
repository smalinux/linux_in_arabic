...
4. Draw the **big picture architecture** as ASCII diagram:
   - Where does this subsystem sit in the kernel?
   - Consumers (drivers that use it)
   - Providers (hardware-specific implementations)
5. Explain the **two-halves model** if applicable (core framework vs hardware ops).
6. List which **files make up** this subsystem (core, headers, hw drivers).
